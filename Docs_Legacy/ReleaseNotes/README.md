...
3. **Cross-reference design docs.** For every major feature, check `Docs/Design/` and
   `Docs/Strategy/` — pull the "why" and architectural context into the release note.
...
| :--- | :--- |
| `scripts/Invoke-Release.ps1` | Resolves `Docs/ReleaseNotes/$Tag.md` as the GitHub Release body |
...
| `Docs/Release_Checklist.md` | Phase 1 requires authoring this file before tagging |
...
- [Release Checklist](../Release_Checklist.md) — the full release process
- [CHANGELOG.md](../../CHANGELOG.md) — exhaustive developer-oriented change log
- [Release Capability Matrix](../Strategy/Release_Capability_Matrix.md) — evidence requirements
- [Release Workflows](../Strategy/Release_Workflows.md) — CI/CD and validation strategy
