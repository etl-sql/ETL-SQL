...
public sealed class GovernanceEnforcementAuditTests
{
    ...
    private static readonly IReadOnlyDictionary<string, (Boundary Kind, string Where)> Map =
        new Dictionary<string, (Boundary, string)>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["SecurityEvents:CollectorEndpoint"] = (Boundary.EnterpriseSnapshot, "EnterprisePolicyRuntime security-event transport startup"),
            ...
            ["SecurityEvents:FailClosedMaxTerminalFailures"] = (Boundary.EnterpriseSnapshot, "SecurityEventHealthGate at execution start"),
            ["SecurityEvents:FailClosedMaxOldestEventSeconds"] = (Boundary.EnterpriseSnapshot, "SecurityEventHealthGate at execution start"),
            ["SecurityEvents:FailClosedMaxPendingEvents"] = (Boundary.EnterpriseSnapshot, "SecurityEventHealthGate at execution start"),
            ["SecurityEvents:FailClosedMaxOutboxBytes"] = (Boundary.EnterpriseSnapshot, "SecurityEventHealthGate at execution start"),
