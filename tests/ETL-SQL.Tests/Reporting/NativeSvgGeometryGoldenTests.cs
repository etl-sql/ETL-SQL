...
public sealed class NativeSvgGeometryGoldenTests(ITestOutputHelper output)
{
    private static readonly Dictionary<string, string> RepresentativeGoldens = new(StringComparer.Ordinal)
    {
        ...
        ["scatter_multi_series_inferred.rptsql"] = "358C21FA0FD50C2D8AB3464D31BA5B16BD7D13F3B18B8BC2E499EC969E6C28D0",
        ...
        ["rule_statistical_overlays.rptsql"] = "8E9B33385BE1C5E278A9B86581EB13B52C8ED469FFB9BCC30CBA0DB92CC5012A"
    };
