...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = T));
");
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = B));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = RegionFilter));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = RegionPicker));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = SalesChart));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = MyVis));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = ClearBtn));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A B', MAP('A' = Summary, 'B' = Detail));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = G));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = Mix));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
...
CREATE PAGE P AS LAYOUT (STRUCTURE = 'A', MAP('A' = Info));
");
            await using var svc = Svc(path);
            var m = await svc.GetManifestAsync();
