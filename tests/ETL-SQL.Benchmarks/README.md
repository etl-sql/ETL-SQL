...
- `SelectPipelineBenchmarks`: spill-backed SELECT pipeline paths that should preserve streaming through non-blocking stages: external aggregate + LIMIT, external aggregate + Top-N, and external window + QUALIFY + LIMIT.
