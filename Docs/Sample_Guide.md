...
### 1. [sample.etlsql](../samples/sample.etlsql)
...
### 2. [sample_batch.etlsql](../samples/sample_batch.etlsql)
...
### 3. [sample_db.etlsql](../samples/sample_db.etlsql)
...
### 4. [sample_aggregation.etlsql](../samples/sample_aggregation.etlsql)
...
### 5. [sample_window_functions.etlsql](../samples/sample_window_functions.etlsql)
...
### 6. [sample_subqueries.etlsql](../samples/sample_subqueries.etlsql)
...
### 7. [sample_modular_etl.etlsql](../samples/sample_modular_etl.etlsql)
...
### 8. [sample_variables.etlsql](../samples/sample_variables.etlsql)
...
### 9. [sample_lists.etlsql](../samples/sample_lists.etlsql)
...
### 10. [sample_connection_options.etlsql](../samples/sample_connection_options.etlsql)
...
### 11. [sample_complex_query.etlsql](../samples/sample_complex_query.etlsql)
...
### 12. [sample_preview.etlsql](../samples/sample_preview.etlsql)
**Purpose**: Using the preview mode.
- Demonstrates how to limit result sets for quick data inspection.

### 13. [sample_what_if.etlsql](../samples/sample_what_if.etlsql)
...
### 14. [sample_docker.etlsql](../samples/sample_docker.etlsql)
...
### 15. [sample_mega_integration.etlsql](../samples/sample_mega_integration.etlsql)
...
### 16. [sample_ansi_sql.etlsql](../samples/sample_ansi_sql.etlsql)
...
### 17. [sample_statistics.etlsql](../samples/sample_statistics.etlsql)
...
### 18. [sample_temporal.etlsql](../samples/sample_temporal.etlsql)
...
### 19. [sample_fixed_width.etlsql](../samples/sample_fixed_width.etlsql)
...
### 20. [sample_enhanced_io.etlsql](../samples/sample_enhanced_io.etlsql)
...
### 21. [sample_jobs.etlsql](../samples/sample_jobs.etlsql)
...
### 22. [sample_avro.etlsql](../samples/sample_avro.etlsql) / [sample_parquet.etlsql](../samples/sample_parquet.etlsql)
...
### 23. [sample_JoinHintsTest.etlsql](../samples/sample_JoinHintsTest.etlsql)
...
### 24. [sample_BulkInsertColumnsTest.etlsql](../samples/sample_BulkInsertColumnsTest.etlsql)
...
### 25. [sample_StressTest.etlsql](../samples/sample_StressTest.etlsql)
...
### 26. [realworld_01_dw_load.etlsql](../samples/realworld_01_dw_load.etlsql)
...
### 27. [realworld_02_secure_sftp_alert.etlsql](../samples/realworld_02_secure_sftp_alert.etlsql)
...
### 28. [realworld_03_schema_quarantine.etlsql](../samples/realworld_03_schema_quarantine.etlsql)
...
### 29. [realworld_04_incremental_merge.etlsql](../samples/realworld_04_incremental_merge.etlsql)
...
### 30. [realworld_05_masking_json.etlsql](../samples/realworld_05_masking_json.etlsql)
...
### 31. [realworld_06_reconciliation_anti_join.etlsql](../samples/realworld_06_reconciliation_anti_join.etlsql)
...
### 32. [realworld_07_window_deduplication.etlsql](../samples/realworld_07_window_deduplication.etlsql)
...
### 33. [realworld_08_aggregation_pivot.etlsql](../samples/realworld_08_aggregation_pivot.etlsql)
...
### 34. [realworld_09_directory_watcher.etlsql](../samples/realworld_09_directory_watcher.etlsql)
...
### 35. [realworld_10_docker_sync.etlsql](../samples/realworld_10_docker_sync.etlsql)
