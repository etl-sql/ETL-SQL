...
| `Modules.Reporting` | `true` | Feature flag for the report library entry page plus report catalog, report player, datasets, subscriptions, catalog search, and report export APIs. Disabled routes return 404. |
...
| `Modules.Operations` | `true` | Feature flag for operational health, fleet status, audit, and administrative telemetry. Route fencing is a later modularization slice. |
