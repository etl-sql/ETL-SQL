...
### References
- [Session Checkpointing Grammar Reference](../Reference/Grammar.md#413-labels-and-goto)
- [Language Server Protocol Handlers](../Architecture/LanguageServer.md)
- [ETL Notebook Guide](../ETL_Notebook_Guide.md)
