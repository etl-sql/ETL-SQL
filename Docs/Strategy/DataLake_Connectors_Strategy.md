...
- [ ] `Docs/Reference/Data_Connectors.md`: Add a **Data Warehouse Connections** section that leads with the ODBC path (covers Redshift, Databricks, Synapse, Trino, Dremio) and notes which platforms have native connectors (Snowflake, BigQuery).
