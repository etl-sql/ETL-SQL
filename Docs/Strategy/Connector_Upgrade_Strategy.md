...
- **[Connectors Architecture](../Architecture/Connectors.md)**: Details on the `IConnector`/`IDataSource` interfaces, operational **Archetypes** (Expansion vs. Creation), and the **IDatabaseSource** pushdown bridge.
