...
or `./scripts/Test-GateF.ps1 -Scenario ExternalJoin` runs an operator candidate, and
`./scripts/Test-GateFEvidence.ps1 -RequiredScenario ExternalSort` or `-RequiredScenario ExternalJoin`
