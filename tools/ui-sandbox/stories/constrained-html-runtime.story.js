export default {
  ...
  subtitle: 'Sanitized components, server-resolved inline indicators, semantic fallback, actions, and bounded visual embedding',
  ...
  async mount(stage, _fixtureId, ctx) {
    ...
    ctx.stat('Canonical report-runtime.js — sanitized DOM, trusted micro-chart SVG, and bounded manifest embedding');
