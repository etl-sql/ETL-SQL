...
- [ ] **Priority 6: Spill-Aware Table Operators** — Add spill-backed PIVOT paths and documented limits/spill warnings for MATCH_RECOGNIZE; UNPIVOT already has a streaming path.
