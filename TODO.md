...
- [ ] **Diagnostic gutter annotations** — `_diagnostics` list is populated and F8/Shift+F8 navigate entries, but no gutter symbol (`⚠`/`✗`) or line-number color change marks the error line in the editor.
