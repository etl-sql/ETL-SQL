...
- [ ] **Remaining Phase 1:** admin real-impersonation endpoint (effective = target, real = admin; unconditionally never-cached; dual-identity audit); disable scheduled/background refresh for identity-sensitive reports; Portal integration test proving cross-viewer isolation; Administrators_Guide / Security docs section.
