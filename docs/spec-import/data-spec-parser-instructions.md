...
The machine-readable contract is maintained at `spec_pipeline.schema.json`. Do not include comments, markdown fences, or fields from both shapes in the same output.
