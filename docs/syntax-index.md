...
| `DELTA_LABEL` | `CARD` | String / Column | Label shown next to the delta (static string in `OPTIONS` or column binding in `MAPPINGS`) |
| `VALUE_COLOR` | `CARD` | CSS color | Static color override for the primary card value |
...
| Token | Family | Notes |
| :--- | :--- | :--- |
| `ACTIVE_STYLE` | General | Canonical language token |
...
| `ANNOTATIONS` | General | Canonical language token |
| `AXIS_FONT_COLOR` | General | Canonical language token |
| `AXIS_FONT_SIZE` | General | Canonical language token |
| `AXIS_TITLE_FONT_SIZE` | General | Canonical language token |
| `BACK` | General | Canonical language token |
| `BADGE` | General | Canonical language token |
...
| `BREAKPOINT` | General | Canonical language token |
| `BULK` | General | Canonical language token |
| `BUTTON` | General | Canonical language token |
| `BUTTON_BAR` | General | Canonical language token |
...
| `COLOR_SCALE` | General | Canonical language token |
...
| `COORD` | General | Canonical language token |
| `CROSSHAIR` | General | Canonical language token |
| `CROSSHAIR_AXIS` | General | Canonical language token |
| `CROSSHAIR_COLOR` | General | Canonical language token |
| `CROSSHAIR_DASH` | General | Canonical language token |
...
| `DEFAULT_SORT` | General | Canonical language token |
...
| `DISABLED_DATES` | General | Canonical language token |
| `DISABLED_DAYS` | General | Canonical language token |
| `DISCONNECT` | General | Canonical language token |
| `EMIT_FILTER` | General | Canonical language token |
...
| `FIELDS` | General | Canonical language token |
| `FILL_OPACITY` | General | Canonical language token |
| `FILTER` | General | Canonical language token |
| `FIRE_ON` | General | Canonical language token |
| `FISCAL_YEAR_START` | General | Canonical language token |
| `FONT_FAMILY` | General | Canonical language token |
| `FORCE` | General | Canonical language token |
| `FORMAT` | General | Canonical language token |
| `FREEZE` | General | Canonical language token |
...
| `GOAL2` | General | Canonical language token |
| `GOAL2_LABEL` | General | Canonical language token |
| `HANDLING` | General | Canonical language token |
| `HASH_FILE` | General | Canonical language token |
| `HELP` | General | Canonical language token |
| `HIDE_INVISIBLE` | General | Canonical language token |
| `HIDE_MODAL` | General | Canonical language token |
...
| `IMAGE_FIT` | General | Canonical language token |
| `IMAGE_POSITION` | General | Canonical language token |
| `IMAGE_SIZE` | General | Canonical language token |
...
| `INTERPOLATION` | General | Canonical language token |
...
| `LINE_DASH` | General | Canonical language token |
...
| `LINK_TOOLTIP` | General | Canonical language token |
...
| `LTTB` | General | Canonical language token |
...
| `MATCH_MODE` | General | Canonical language token |
...
| `MAX_OPTIONS` | General | Canonical language token |
...
| `MIN_CHARS` | General | Canonical language token |
| `MIN_SLICE_PCT` | General | Canonical language token |
| `MOBILE_LAYOUT` | General | Canonical language token |
...
| `NULL_HANDLING` | General | Canonical language token |
...
| `ON_SUBMIT` | General | Canonical language token |
| `OPEN_URL` | General | Canonical language token |
...
| `PARAMS` | General | Canonical language token |
...
| `PLOT_BACKGROUND` | General | Canonical language token |
| `PLOT_BORDER` | General | Canonical language token |
| `POINT` | General | Canonical language token |
...
| `PROGRESSIVE` | General | Canonical language token |
| `PROGRESSIVE_CHUNK` | General | Canonical language token |
...
| `QUICK_PICKS` | General | Canonical language token |
| `REFERENCE_LINE` | General | Canonical language token |
...
| `RESET_PARAMETERS` | General | Canonical language token |
...
| `SAMPLING` | General | Canonical language token |
| `SEARCHABLE` | General | Canonical language token |
| `SELECT_ALL_LABEL` | General | Canonical language token |
...
| `SHOW_DATA_VIEW` | General | Canonical language token |
| `SHOW_EXPORT` | General | Canonical language token |
| `SHOW_MEAN` | General | Canonical language token |
| `SHOW_MODAL` | General | Canonical language token |
| `SHOW_PERCENT` | General | Canonical language token |
| `SHOW_SELECT_ALL` | General | Canonical language token |
| `SHOW_TICKS` | General | Canonical language token |
...
| `STEP_AFTER` | General | Canonical language token |
| `STEP_BEFORE` | General | Canonical language token |
...
| `TARGETS` | General | Canonical language token |
| `TICK_LABELS` | General | Canonical language token |
...
| `TOOLTIP_MODE` | General | Canonical language token |
| `TOOLTIP_POSITION` | General | Canonical language token |
| `TOTAL_POSITION` | General | Canonical language token |
...
| `VALUE_COLOR` | General | Canonical language token |
...
| `WEEK_START` | General | Canonical language token |
...
| `ZOOM` | General | Canonical language token |
| `ZOOM_GROUP` | General | Canonical language token |
...
| `SOURCE_MAX` | Function | Canonical built-in function |
| `SOURCE_MIN` | Function | Canonical built-in function |
