...
| [CORR](corr.md) | Returns the Pearson correlation coefficient of two numeric expressions across a group. |
| [COUNT](count.md) | Returns the number of rows or non-NULL values in a group or window. |
| [COVAR_POP](covar_pop.md) | Returns the population covariance of two numeric expressions across a group. |
| [COVAR_SAMP](covar_samp.md) | Returns the sample covariance of two numeric expressions across a group. |
