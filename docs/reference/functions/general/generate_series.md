...
## See Also
- [Standard Library — §10. Collection & List Functions](../../../guides/getting-started.md#10-collection--list-functions)
- Related: [`SORT_LIST`](sort_list.md), [`APPEND_TO_LIST`](../collections/append_to_list.md)
