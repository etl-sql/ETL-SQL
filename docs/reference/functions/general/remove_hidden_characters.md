...
- Related: [`REMOVE_HTML_CHARACTERS`](remove_html_characters.md), [`REPLACE`](../string/replace.md), [`TRANSLATE`](../string/translate.md), [`TRIM`](../../../guides/getting-started.md#36-translation--escaping)
