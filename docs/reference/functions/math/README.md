...
| [DEGREES](degrees.md) | Converts an angle value in radians to degrees. |
| [EXP](exp.md) | Returns e (Euler's number) raised to the specified power. |
| [FLOOR](floor.md) | Returns the largest integer less than or equal to a number. |
| [LOG](log.md) | Returns the natural logarithm (base e) of a number. |
