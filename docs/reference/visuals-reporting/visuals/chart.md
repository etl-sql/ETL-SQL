...
- **Intervals** — Paired `Y_START`/`Y_END` creates an AREA ribbon or vertical RULE span; `X_START`/`X_END` supplies the symmetric horizontal range. Endpoint calculations stay in SQL.
