...
| Page | Description |
| :--- | :--- |
| [Seeded Acceptance Profile](acceptance-profile.md) | A small, reproducible dataset for checking that a Portal deployment actually works — after an |
...
| [SMTP Connections and Subscriptions](connections-and-subscriptions.md) | Configuring SMTP so the Portal can deliver report subscriptions, and managing those subscriptions. |
| [Deployment and First-Run Setup](deployment.md) | Deploying the Portal as a managed service and completing first-run setup. |
...
| [User Management](users.md) | Creating and managing Portal accounts, and connecting them to an enterprise identity provider. |
