...
- [Configuration Files](config-file-locations.md) - The published services read `appsettings.json`, environment variables, and encrypted configuration values. Production templates live beside the service projects:
...
- [Configuration Settings Reference](appsettings-reference.md) - Canonical reference for all `appsettings.json` keys, environment variable mappings, and ad-hoc `SET` overrides.
