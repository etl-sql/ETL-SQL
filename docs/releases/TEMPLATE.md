...
<!-- The 2-5 most important features of this release. Each one gets a subsection.
     ...
     4. Reference the design doc if one exists: `docs/architecture/decisions/...` or `docs/architecture/roadmaps/...`.
...
> **Design context:** Link to the relevant architecture decision or roadmap for architectural rationale.
