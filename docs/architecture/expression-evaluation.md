...
Precedence is encoded by the parser's recursive-descent structure (see [ParserLexer.md](parser-lexer.md) §4). At evaluation time, the AST already encodes the correct structure — the evaluator just walks it.
