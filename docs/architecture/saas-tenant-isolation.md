...
[deployment-profiles.md](deployment-profiles.md) owns the common four-profile model and provider
substitution. [TenantPortability.md](tenant-portability.md) owns export/import and customer exit.
[Enterprise_Platform_Strategy.md](roadmaps/enterprise-platform-strategy.md) owns the Enterprise
...
[deployment-profiles.md](deployment-profiles.md#10-execution-and-checkpoint-contract): server-derived
