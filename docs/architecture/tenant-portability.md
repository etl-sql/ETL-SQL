...
**Parent architecture:** [Deployment Profile Architecture](deployment-profiles.md)

**Isolation requirements:** [SaaS Tenant Isolation Architecture](saas-tenant-isolation.md)
...
[DeploymentProfiles.md](deployment-profiles.md) owns the common profile and provider architecture.
[SaaSTenantIsolation.md](saas-tenant-isolation.md) owns tenant isolation and Gateway execution.
[Deployment_Profile_Strategy.md](roadmaps/deployment-profile-strategy.md) owns adoption journeys and
