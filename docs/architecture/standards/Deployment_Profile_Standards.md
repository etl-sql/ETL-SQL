...
| Tenant isolation | **N/A** — one trusted local operator and no tenant boundary | **N/A** — one team/organization and no mutually untrusted tenant boundary | [**Yellow** — organization/department controls exist; hard multi-tenant proof is out of profile](../roadmaps/Enterprise_Platform_Strategy.md) | [**Green** — Managed Dedicated is certified only by its own clean, commit-bound lane and cannot satisfy Shared SaaS](../roadmaps/Deployment_Profile_Strategy.md#dp-12--prove-isolation-and-failure-containment) | [**Green** — the separate `SharedSaaS` lane requires clean, commit-bound hostile evidence across every shared isolation surface; Dedicated evidence cannot satisfy this cell](../roadmaps/Deployment_Profile_Strategy.md#dp-12--prove-isolation-and-failure-containment) |
