...
- **When adding a new connector**: all applicable rules must be ✓ before the PR can merge. See [Connectors_Standards.md](connectors-standards.md) Part I for the full rule text.
