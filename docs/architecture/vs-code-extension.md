...
For the language server the extension hosts, see [LanguageServer.md](language-server.md).
...
1. Implement the handler in `ETL-SQL.LanguageServer` (see [LanguageServer.md](language-server.md))
