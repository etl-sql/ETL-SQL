...
- [Grammar-of-Graphics Contract ADR](GrammarOfGraphicsSpecIR.md)
- [Reporting Semantic Contracts](../ReportingSemanticContracts.md)
- [Language Syntax Standards](../standards/Language_Syntax_Standards.md)
- [Report Runtime Asset Standards](../standards/Report_Runtime_Asset_Standards.md)
