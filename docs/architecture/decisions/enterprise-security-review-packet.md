...
- HA readiness behavior when PostgreSQL, shared storage, load balancer affinity, key ring, or JWT
  ...
  [HA Topology Failure Certification](ha-topology-failure-certification.md#how-expectedmode-auto-resolves--and-why-it-can-take-a-healthy-node-out-of-rotation).
...
- [Enterprise Release Gates](enterprise-release-gates.md)
...
- [HA Topology Failure Certification](ha-topology-failure-certification.md)
- [Disaster Recovery Objectives](disaster-recovery-objectives.md)
