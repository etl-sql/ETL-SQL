...
Use the [Enterprise Security Review Packet](enterprise-security-review-packet.md) for the senior
security review record and the
[Enterprise Release Evidence Checklist](enterprise-release-evidence-checklist.md) for full-suite
...
[Enterprise Security Review Packet](enterprise-security-review-packet.md).
...
[Enterprise Release Evidence Checklist](enterprise-release-evidence-checklist.md).
