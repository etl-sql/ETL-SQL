...
### References
- [Language Server Architecture](../language-server.md)
- [Portal UI — Lite Editor & technology choices](../portal-ui.md#5-technology-choices)
- [Portal architecture (auth, API, middleware)](../portal.md)
- [Zero-Trust Operations & Security](../standards/connectors-standards.md)
