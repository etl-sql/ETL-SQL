...
> [!NOTE]
> The shipped fuzzy matching surface is documented in `docs/guides/getting-started.md` and `docs/guides/getting-started.md`. Phase 5 embedding/semantic matching is future work and is not part of the 0.7.0 feature-complete surface.
