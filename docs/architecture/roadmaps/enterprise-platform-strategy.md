...
**Deployment-profile architecture:** See [`DeploymentProfiles.md`](../deployment-profiles.md)
...
[`docs/architecture/decisions/Enterprise_Release_Gates.md`](../decisions/enterprise-release-gates.md) defines the
