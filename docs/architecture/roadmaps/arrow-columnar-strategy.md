...
> [!NOTE]
> **Implemented design note.** The columnar spill format described here shipped in ETL-SQL 0.7.0. Use this file to understand the design rationale. For current spill behavior and configuration, see `Docs/Architecture/Engine.md` and `docs/architecture/roadmaps/LargeDatasets.md`.
...
- Spill-to-disk for `#temp` tables (`InMemoryDataSource`) — that is a separate item (large-datasets.md §5).
