...
> [!IMPORTANT]
> **Active but unaudited strategy.** Treat this as a roadmap candidate, not current product reference. Before implementing from this file, audit it against `docs/reference/statements/lineage.md`, `Docs/Architecture/Engine.md`, the current lineage analyzer, and report/portal behavior.
...
**Deliverables:** `docs/reference/statements/lineage.md`, updated `Help/Operations/LINEAGE.md`, updated `Grammar.md`
...
See `docs/reference/statements/lineage.md` for the full reference. Summary of the 20 standard tags defined across five domains:
...
- Documented in `docs/reference/statements/lineage.md` and the help system
