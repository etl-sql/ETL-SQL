...
| [Inventory Heatmap & Low-Stock Alerts](inventory-heatmap.md) | **Pattern**: A warehouse bin heatmap shows stock intensity at a glance. A table below highlights items below reorder point in red. |
| [Marginal Scatter & Quadrant Benchmarks](custom-marginal-scatter-plot.md) | **Pattern**: High-density 2D distribution analysis combining scatter data points with marginal reference thresholds and quadrant risk benchmarks. |
