...
> ```
> Use `SHOW VERSION;` to display version info from within a script session. The current release baseline is **v0.16.0**.
...
*Not finding your answer here? Open a [GitHub Discussion](https://github.com/etl-sql/ETL-SQL/discussions) or check [Getting Started](getting-started.md) and the [Cookbook](../cookbooks/etl-recipes.md).*
