...
This guide is for operators who install, configure, back up, and monitor ETL-SQL in production or shared test environments. For day-to-day portal administration, see [Report Portal Administration](report-portal-admin.md). For command-line job operations, see [Job Orchestration](job-orchestration.md). For Report Portal and Orchestrator server sizing, see [Capacity Planning](../architecture/decisions/Capacity_Planning.md).
...
1. Run the `ETL-SQL-Enterprise-v0.15.0.msi` installer.
...
```bash
sudo dpkg -i etl-sql_0.15.0_amd64.deb
