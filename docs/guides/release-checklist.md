...
[`docs/architecture/roadmaps/Release_Workflows.md`](../architecture/roadmaps/Release_Workflows.md); this file is the step list.
...
Replace `x.y.z` with the target version (current target: **0.16.0**) throughout.
...
- [x] **RLS Publisher preview-as data access — RESOLVED (2026-07-02).** Not an escalation and needs
      ...
      responsibility, out of scope. See open question 1 in [`docs/architecture/decisions/RowLevelSecurity.md`](../architecture/decisions/RowLevelSecurity.md).
