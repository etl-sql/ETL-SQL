...
[§6.5](../portal-admin/publishing.md#versioned-upgrades-and-rollback).
...
[Portal Admin Guide: Versioned Upgrades and Rollback](../portal-admin/publishing.md#versioned-upgrades-and-rollback).
