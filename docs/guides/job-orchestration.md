...
*For complete function and connector references, see [Reference/Standard_Library.md](getting-started.md) and [Reference/Data_Connectors.md](administration.md).*
