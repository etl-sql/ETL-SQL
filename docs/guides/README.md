...
| [Catalog Search & Discovery](catalog-search.md) | Fuzzy tokenized search, relevance ranking, and business consumer home dashboard. |
| [Report Ownership & Freshness Badges](report-badges-freshness.md) | Standardized report metadata badges (owner, steward, certification, freshness, tags). |
