# Operations & Performance Guides

[« Back to Guides](../README.md)

These guides cover operational runtime behaviors, logging, profiling, and solo-operator automation workflows in ETL-SQL.
...
For enterprise multi-node deployment, High Availability (HA), OIDC, and reverse proxy settings, see the **[Platform Administration Guide](../../administration/platform/README.md)**.
