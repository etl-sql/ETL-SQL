...
namespace ETL_SQL.UI
{
    ...
    public class ETLSuggestEngine
    {
        ...
        public static async Task<List<Suggestion>> GetSuggestionsAsync(string prefix, string fullScript, IDictionary<string, IDataSource> connections)
        {
        ...
        public static List<string> GetFileSuggestions(string prefix)
        {
            ...
            catch (Exception ex) { Logger.Verbose($"[ETLSuggestEngine.GetFileSuggestions] File system error for prefix '{prefix}': {ex.Message}"); }
