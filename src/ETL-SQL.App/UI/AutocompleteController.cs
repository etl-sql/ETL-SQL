...
namespace ETL_SQL.UI
{
    ...
    public class AutocompleteController
    {
        ...
        public AutocompleteController(EditorBuffer buffer, EditorRenderer renderer, MetadataManager metadata, Dictionary<string, IDataSource> connections)
        {
            _buffer = buffer;
            _renderer = renderer;
            _metadata = metadata;
        ...
        public async Task UpdateAsync()
        {
            ...
            _renderer.AutocompleteOptions = await ETLSuggestEngine.GetSuggestionsAsync(lastWord, _buffer.GetText(), _connections);
            sw.Stop();
