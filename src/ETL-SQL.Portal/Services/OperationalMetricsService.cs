    ...
    PortalTenantCatalogScope? catalogScope = null)
{
    ...
    public sealed record OperationalMetrics(
        ...
        bool StorageUsageSampleStale,
        DateTimeOffset? StorageUsageLastSuccessfulSampleUtc,
        DateTimeOffset? StorageUsageLastFailureUtc,
        int StaleSnapshots,
        int StaleDatasets,
    ...
    public async Task<OperationalMetrics> GetAsync(CancellationToken ct = default)
    {
        ...
        return new OperationalMetrics(
            ...
            storageUsage?.IsStale ?? false,
            storageUsage?.LastSuccessfulSampleUtc,
            storageUsage?.LastFailureUtc,
            staleSnapshots,
            staleDatasets,
