...
internal static class AdvancedChartEnumBridge
{
    ...
    internal static FieldChannel Channel(AdvancedChartChannel value) => value switch
    {
        ...
        AdvancedChartChannel.Mean => FieldChannel.Mean,
        AdvancedChartChannel.Open => FieldChannel.Open,
        AdvancedChartChannel.Close => FieldChannel.Close,
        AdvancedChartChannel.ErrorLow => FieldChannel.ErrorLow,
        AdvancedChartChannel.ErrorHigh => FieldChannel.ErrorHigh,
        AdvancedChartChannel.ConfidenceLow => FieldChannel.ConfidenceLow,
        AdvancedChartChannel.ConfidenceHigh => FieldChannel.ConfidenceHigh,
    ...
    internal static AdvancedChartChannel? Channel(FieldChannel value) => value switch
    {
        ...
        FieldChannel.Mean => AdvancedChartChannel.Mean,
        FieldChannel.Open => AdvancedChartChannel.Open,
        FieldChannel.Close => AdvancedChartChannel.Close,
        FieldChannel.ErrorLow => AdvancedChartChannel.ErrorLow,
        FieldChannel.ErrorHigh => AdvancedChartChannel.ErrorHigh,
        FieldChannel.ConfidenceLow => AdvancedChartChannel.ConfidenceLow,
        FieldChannel.ConfidenceHigh => AdvancedChartChannel.ConfidenceHigh,
