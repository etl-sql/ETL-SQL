...
public class Lexer
{
    ...
    private static Dictionary<string, TokenType> InitializeKeywords()
    {
        ...
        dict["FILE_SEND"] = TokenType.FILE_SEND;
        dict["FILE_RECEIVE"] = TokenType.FILE_RECEIVE;
        dict["COPY_FILE"] = TokenType.COPY_FILE;
        dict["MOVE_FILE"] = TokenType.MOVE_FILE;
        dict["RENAME_FILE"] = TokenType.RENAME_FILE;
        dict["DELETE_FILE"] = TokenType.DELETE_FILE;
        dict["COMPRESS_FILE"] = TokenType.COMPRESS_FILE;
        dict["DECOMPRESS_FILE"] = TokenType.DECOMPRESS_FILE;
        dict["ENCRYPT_FILE"] = TokenType.ENCRYPT_FILE;
        dict["DECRYPT_FILE"] = TokenType.DECRYPT_FILE;
        dict["CREATE_DIRECTORY"] = TokenType.CREATE_DIRECTORY;
        dict["DELETE_DIRECTORY"] = TokenType.DELETE_DIRECTORY;
        dict["RENAME_DIRECTORY"] = TokenType.RENAME_DIRECTORY;
        dict["MOVE_DIRECTORY"] = TokenType.MOVE_DIRECTORY;
        dict["COPY_DIRECTORY"] = TokenType.COPY_DIRECTORY;
        dict["DELETE_DIRECTORY_CONTENTS"] = TokenType.DELETE_DIRECTORY_CONTENTS;
        dict["COMPRESS_DIRECTORY"] = TokenType.COMPRESS_DIRECTORY;
        dict["DECOMPRESS_DIRECTORY"] = TokenType.DECOMPRESS_DIRECTORY;
        dict["ENCRYPT_DIRECTORY"] = TokenType.ENCRYPT_DIRECTORY;
        dict["DECRYPT_DIRECTORY"] = TokenType.DECRYPT_DIRECTORY;
