...
## Remarks
- Uses SQL `LIKE`-style wildcards (`%`, `_`), not regex. Use [`REGEXP_INSTR`](REGEXP_INSTR.md) for regex-based position searches.
...
- Related: [`CHARINDEX`](CHARINDEX.md), [`REGEXP_INSTR`](REGEXP_INSTR.md)
