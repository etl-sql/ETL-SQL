...
namespace ETL_SQL.Common
{
    public static class LanguageMetadata
    {
        ...
        public static readonly HashSet<string> Keywords = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "PRINT", "STEP", "IN", "TO", "SHOW", "PROFILING", "PROFILE", "OFF", "ON", "WHAT_IF", "SYSDATE", "PERCENT", "TIES", "FILTER",
            ...
            "GAUGE_STYLE", "SHOW_NO_DATA_PLACEHOLDER", "CROSS_VISUAL_ACTION", "HIGHLIGHT",
            ...
            "GAUGE", "FUNNEL", "WATERFALL", "BOXPLOT", "TREEMAP", "HEATMAP", "COMBO", "MAP", "STRUCTURE", "MAPPINGS", "ACTIONS", "RUN_SCRIPT"
        };
