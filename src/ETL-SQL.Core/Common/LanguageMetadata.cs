...
public static class LanguageMetadata
{
    ...
    public static readonly HashSet<string> Keywords = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "COLOR_MET", "COLOR_CLOSE", "COLOR_MISSED", "VALUE_COLOR",
        "ICON_MET", "ICON_CLOSE", "ICON_MISSED", "ICON_SET",
        "DELTA_FORMAT", "DELTA_LABEL", "TREND_DIR", "REFERENCE_LINE",
        "GOAL2", "GOAL2_LABEL", "COLOR_SCALE", "FONT_FAMILY", "ZOOM",
        "SEARCHABLE", "MAX_OPTIONS", "IMAGE_SIZE", "IMAGE_POSITION", "IMAGE_FIT",
        "SHOW_SELECT_ALL", "SELECT_ALL_LABEL", "CLEAR_ALL_LABEL",
        "DISABLED_DATES", "DISABLED_DAYS", "WEEK_START",
        "QUICK_PICKS", "FISCAL_YEAR_START", "SHOW_TICKS", "TICK_LABELS", "FIRE_ON",
        "MATCH_MODE", "MIN_CHARS", "CHIPS", "BUTTON_BAR",
        "PREFIX", "SUFFIX",
        ...
        "GAUGE", "FUNNEL", "WATERFALL", "BOXPLOT", "TREEMAP", "HEATMAP", "COMBO", "MAP", "STRUCTURE", "GAP", "MAPPINGS", "ACTIONS", "ON_SUBMIT", "RUN_SCRIPT", "CLEAR_FILTERS",
        ...
        "RESET_PARAMETERS", "OPEN_URL", "SHOW_MODAL", "HIDE_MODAL", "COLLAPSIBLE", "BADGE",
        "MOBILE_LAYOUT", "BREAKPOINT", "ANNOTATIONS", "POINT", "COORD", "ACTIVE_STYLE", "HIDE_INVISIBLE",
        "NULL_HANDLING", "TOOLTIP_MODE", "TOOLTIP_POSITION", "CROSSHAIR", "CROSSHAIR_AXIS", "CROSSHAIR_COLOR", "CROSSHAIR_DASH", "LINK_TOOLTIP",
        "INTERPOLATION", "STEP_BEFORE", "STEP_AFTER", "LINE_DASH",
        "PLOT_BACKGROUND", "PLOT_BORDER", "AXIS_FONT_SIZE", "AXIS_FONT_COLOR", "AXIS_TITLE_FONT_SIZE",
        "SAMPLING", "LTTB", "PROGRESSIVE", "PROGRESSIVE_CHUNK",
        "SHOW_EXPORT", "SHOW_DATA_VIEW", "ZOOM_GROUP",
        "EMIT_FILTER", "TARGETS", "FIELDS", "PARAMS"
    };
