...
public partial class SecurityService
{
    ...
    private static readonly string[] AllowedExtensions = { ".csv", ".json", ".parquet", ".avro", ".db", ".enc", ".pgp", ".asc", ".gpg", ".key", ".gz", ".7z", ".txt", ".sql", ".log", ".xlsx", ".xml", ".yaml", ".yml", ".ini", ".md", ".zip", ".dat", ".tsv", ".psv", ".fixed", ".etlds", ".etlsnap", ".tmp" };
