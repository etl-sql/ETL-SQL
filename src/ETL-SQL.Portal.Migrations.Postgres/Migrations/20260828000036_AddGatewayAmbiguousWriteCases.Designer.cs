...
namespace ETLSQL.Portal.Migrations.Postgres.Migrations
{
    ...
    [Migration("20260828000036_AddGatewayAmbiguousWriteCases")]
    partial class AddGatewayAmbiguousWriteCases
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETL_SQL.Portal.Data.WorkloadIdentityReplay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "BindingId", "TokenIdHash")
                        .IsUnique();

                    b.ToTable("WorkloadIdentityReplays");
                });
