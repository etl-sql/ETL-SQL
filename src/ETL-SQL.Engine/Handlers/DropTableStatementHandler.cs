...
namespace ETL_SQL.Engine.Handlers
{
    ...
    /// </summary>
    public class DropTableStatementHandler : IStatementHandler
    {
        ...
        public async Task Execute(Statement statement, IExecutionContext context)
        {
            ...
            Logger.Verbose($"Dropping table {stmt.TargetTable.TableName} on {stmt.TargetTable.ConnectionName ?? "local"}");
